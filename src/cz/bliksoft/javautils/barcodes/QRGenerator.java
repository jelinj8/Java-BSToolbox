...
// 
//	public static void createQR(String value, String path) {
//		createQR(value, path, 250, "png");
//	}
//
//	/**
//	 * 
...
//	 * @param size velikost obrázku v pixelech
//	 * @param fileType typ souboru (např. "png");
//	 */
//	public static void createQR(String myCodeText, String filePath, int size, String fileType) {
